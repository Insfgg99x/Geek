...
let SKPhotoBrowserLongPressImageNotification="SKPhotoBrowserLongPressImageNotification"
...
class SKDetectingImageView: UIImageView {
    ...
    @objc func handleLongPress(_ sender:UILongPressGestureRecognizer) {
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue: SKPhotoBrowserLongPressImageNotification), object: self)
    }
}
